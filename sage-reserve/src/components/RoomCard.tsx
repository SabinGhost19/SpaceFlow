  ...
  return (
    <Card className="overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 group bg-slate-800/60 border-white/10">
      ...
      <CardContent className="p-6">
        ...
        <p className="text-sm text-slate-300 mb-4">{room.description}</p>
      ...
      <CardFooter className="p-6 pt-0 flex gap-2">
        ...
        <Button variant="outline" className="bg-slate-700/40 text-white border-slate-600 hover:bg-slate-700">View Details</Button>
      </CardFooter>
    </Card>
  );
};
